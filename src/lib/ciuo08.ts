...
export const CIUO08: CiuoEntry[] = [
  ...
  { codigo: "2141", grupo: "Ingenieros industriales y de producción", titulos: ["ingeniero industrial", "ingeniero de procesos", "ingeniero de producción", "ingeniero de calidad", "ingeniero de manufactura", "ingeniero de planta", "ingeniero de operaciones"] },
  ...
  { codigo: "2143", grupo: "Ingenieros en medioambiente", titulos: ["ingeniero en medioambiente", "ingeniero ambiental", "especialista ambiental", "consultor ambiental"] },
  { codigo: "2144", grupo: "Ingenieros mecánicos", titulos: ["ingeniero mecánico", "ingeniero de mantenimiento", "ingeniero mecánico automotriz"] },
  ...
  { codigo: "2269", grupo: "Profesionales de la salud NCP", titulos: ["terapeuta ocupacional", "terapeuta ocupacional", "químico clínico", "podólogo"] },
  ...
  { codigo: "2320", grupo: "Docentes de educación vocacional y técnica", titulos: ["docente técnico", "instructor técnico", "profesor técnico profesional", "relator"] },
  ...
  { codigo: "2634", grupo: "Sociólogos y trabajadores sociales", titulos: ["sociólogo", "antropólogo", "asistente social", "trabajador social", "terapeuta ocupacional"] },
  ...
  { codigo: "3114", grupo: "Técnicos en electrónica", titulos: ["técnico en electrónica", "técnico electrónico", "técnico en automatización"] },
  { codigo: "3115", grupo: "Técnicos en mecánica", titulos: ["técnico mecánico", "mecánico industrial", "técnico en mecánica", "mecánico automotriz", "técnico automotriz"] },
  ...
  { codigo: "3221", grupo: "Técnicos de enfermería", titulos: ["técnico en enfermería", "TENS", "auxiliar de enfermería", "técnico en atención de enfermería"] },
  { codigo: "3257", grupo: "Técnicos en prevención de riesgos y salud ocupacional", titulos: ["prevencionista de riesgos", "técnico en prevención de riesgos", "experto en prevención de riesgos", "inspector de seguridad", "asesor en prevención", "coordinador de seguridad", "jefe de prevención de riesgos", "profesional en prevención de riesgos"] },
  { codigo: "3311", grupo: "Agentes y ejecutivos bancarios y financieros", titulos: ["corredor de bolsa", "agente de valores", "ejecutivo de cuentas", "ejecutivo bancario", "ejecutivo de negocios", "ejecutivo de banca", "ejecutivo de cuenta"] },
  ...
  { codigo: "3322", grupo: "Representantes y ejecutivos comerciales", titulos: ["representante de ventas", "ejecutivo de ventas", "vendedor técnico", "asesor comercial", "ejecutivo comercial", "representante comercial", "key account manager", "KAM", "account executive"] },
  ...
  { codigo: "3324", grupo: "Agentes de compras y abastecimiento", titulos: ["analista de abastecimiento", "jefe de abastecimiento", "analista de compras", "jefe de compras", "coordinador de compras", "encargado de compras", "analista de logística", "coordinador de logística", "jefe de logística", "planificador de demanda"] },
  ...
  { codigo: "3412", grupo: "Trabajadores sociales de nivel medio", titulos: ["asistente social", "trabajador comunitario", "orientador social", "educador social"] },
  ...
  { codigo: "4110", grupo: "Asistentes y auxiliares administrativos", titulos: ["oficinista", "auxiliar administrativo", "asistente administrativo", "empleado administrativo", "administrativo", "asistente de administración"] },
  ...
  { codigo: "4321", grupo: "Jefes y auxiliares de bodega", titulos: ["jefe de bodega", "auxiliar de bodega", "encargado de bodega", "bodeguero", "controlador de inventario", "pañolero", "encargado de despacho"] },
  ...
  { codigo: "5414", grupo: "Guardias de seguridad", titulos: ["guardia de seguridad", "guardia", "vigilante", "portero de seguridad", "sereno"] },
  ...
  { codigo: "9613", grupo: "Personal de aseo y limpieza", titulos: ["auxiliar de aseo", "personal de aseo", "operario de aseo", "aseador", "camarera de hotel"] },
];
