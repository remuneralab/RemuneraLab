...
export const CIUO08: CiuoEntry[] = [
  ...
  { codigo: "1219", grupo: "Directores y gerentes administrativos y de operaciones", titulos: ["gerente administrativo", "director administrativo", "jefe administrativo", "gerente de operaciones", "director de operaciones", "COO", "jefe de operaciones", "subgerente", "jefe de administración y operaciones"] },
  { codigo: "1221", grupo: "Directores de ventas y marketing", titulos: ["CMO", "director de marketing", "gerente de marketing", "director comercial", "gerente comercial", "director de ventas", "gerente de ventas", "jefe comercial", "jefe de ventas", "jefe de marketing", "jefe de sucursal", "jefe de sucursal de ventas"] },
  ...
  { codigo: "2144", grupo: "Ingenieros mecánicos", titulos: ["ingeniero mecánico", "ingeniero de mantenimiento", "ingeniero mecánico automotriz", "ingeniero de automatización", "especialista en automatización industrial", "ingeniero senior mecánico", "ingeniero automatización", "ingeniero bms", "ingeniero de sistemas de control"] },
  ...
  { codigo: "2166", grupo: "Diseñadores gráficos y multimedia", titulos: ["diseñador gráfico", "diseñadora gráfica", "jefe de diseño", "jefa de diseño", "diseñador UX", "diseñador UI", "diseñador UX UI", "diseñador web", "diseñador multimedia", "diseñador visual", "UX designer", "UI designer", "product designer"] },
  ...
  { codigo: "2262", grupo: "Farmacéuticos", titulos: ["farmacéutico", "químico farmacéutico", "bioquímico farmacéutico", "director técnico químico farmacéutico", "director técnico de farmacia"] },
  ...
  { codigo: "2320", grupo: "Docentes de educación vocacional y técnica", titulos: ["docente técnico", "instructor técnico", "profesor técnico profesional", "relator", "facilitador", "facilitador de capacitación", "capacitador", "utp", "jefe de utp", "jefe de unidad técnico pedagógica"] },
  ...
  { codigo: "2512", grupo: "Desarrolladores de software", titulos: ["desarrollador de software", "desarrollador backend", "desarrollador frontend", "programador", "programador web", "desarrollador full stack", "full stack developer", "backend developer", "frontend developer", "software engineer", "software developer", "ingeniero de software", "ingeniero civil computación", "informático", "desarrollador react", "desarrollador node", "desarrollador python", "desarrollador java"] },
  ...
  { codigo: "2522", grupo: "Administradores de sistemas y redes", titulos: ["administrador de sistemas", "sysadmin", "administrador de redes", "ingeniero de infraestructura", "devops", "devops engineer", "cloud engineer", "SRE", "site reliability engineer", "ingeniero de plataforma", "platform engineer", "administrador de servidores", "técnico de infraestructura cloud", "ingeniero de infraestructura cloud"] },
  { codigo: "2523", grupo: "Especialistas en ciberseguridad", titulos: ["especialista en ciberseguridad", "analista de seguridad", "ingeniero de seguridad informática", "ingeniero de seguridad de la información", "pentester", "analista de ciberseguridad", "hacker ético", "security engineer", "analista de SOC", "arquitecto de seguridad"] },
  ...
  { codigo: "2622", grupo: "Bibliotecólogos y documentalistas", titulos: ["bibliotecólogo", "bibliotecologa", "bibliotecario", "jefe de biblioteca", "encargado de biblioteca", "asistente de biblioteca"] },
  { codigo: "2720", grupo: "Psicólogos", titulos: ["psicólogo", "psicóloga", "terapeuta", "psicólogo clínico", "psicólogo organizacional", "psicóloga clínica", "psicólogo comunitario", "coach", "psicólogo laboral"] },

  // Gran Grupo 3 — Técnicos y profesionales de nivel medio
  { codigo: "3112", grupo: "Técnicos y supervisores de construcción", titulos: ["técnico en construcción", "capataz de obras", "supervisor de obras", "inspector de obras", "jefe de obras", "jefe de obra", "maestro mayor de obras", "jefe de conservación vial", "inspector vial"] },
  ...
  { codigo: "3122", grupo: "Supervisores de producción y manufactura", titulos: ["jefe de producción", "supervisor de producción", "encargado de producción", "jefe de turno", "supervisor de turno", "encargado de turno", "jefe de planta", "supervisor de manufactura", "coordinador de producción", "jefe de operaciones de planta", "jefe de cámara frigorífica", "jefe de cámara fría", "supervisor de bodega frigorífica"] },
  { codigo: "3212", grupo: "Técnicos en laboratorio médico", titulos: ["tecnólogo médico", "técnico de laboratorio", "técnico paramédico", "técnico en laboratorio clínico", "laboratorista dental", "técnico dental", "laboratorista clínico"] },
  { codigo: "3240", grupo: "Técnicos veterinarios", titulos: ["técnico veterinario", "auxiliar veterinario", "asistente veterinario", "técnico en veterinaria", "asistente de clínica veterinaria"] },
  ...
  { codigo: "3333", grupo: "Reclutadores y headhunters", titulos: ["reclutador", "headhunter", "talent acquisition", "analista de selección", "especialista en reclutamiento", "talent sourcer", "analista de atracción de talento", "analista senior de atracción de talento"] },
  { codigo: "3339", grupo: "Técnicos en administración de empresas", titulos: ["técnico en administración de empresas", "técnico en administración", "técnico en gestión", "asistente de administración de empresas", "inspector de contenedores", "inspector aduanero"] },
  ...
  { codigo: "3412", grupo: "Trabajadores sociales de nivel medio", titulos: ["trabajador comunitario", "orientador social", "educador social", "educadora de trato directo", "educador de trato directo", "monitor residencial"] },
  ...
  { codigo: "3433", grupo: "Jefes y coordinadores de contabilidad", titulos: ["jefe de contabilidad", "supervisor contable", "coordinador contable", "encargado de contabilidad", "jefe de cobranzas", "encargado de cobranzas", "supervisor de cobranzas"] },
  ...
  { codigo: "3511", grupo: "Técnicos de soporte TIC", titulos: ["técnico de soporte", "help desk", "soporte técnico", "técnico en computación", "técnico de informática", "operador de sistemas", "técnico on site", "técnico on-site", "técnico de campo"] },
  ...
  { codigo: "4110", grupo: "Asistentes y auxiliares administrativos", titulos: ["oficinista", "auxiliar administrativo", "asistente administrativo", "empleado administrativo", "administrativo", "administración", "asistente de administración", "digitador", "digitador de datos", "ingresador de datos", "operador de datos"] },
  { codigo: "4120", grupo: "Secretarios y asistentes ejecutivos", titulos: ["secretario", "secretaria", "secretaria académica", "asistente ejecutivo", "asistente ejecutivo bilingüe", "asistente de gerencia", "asistente de dirección"] },
  ...
  { codigo: "4311", grupo: "Auxiliares contables y de finanzas", titulos: ["auxiliar contable", "asistente contable", "asistente de contabilidad", "digitador contable", "administrativo contable"] },
  ...
  { codigo: "5311", grupo: "Auxiliares de cuidado de niños y jardín infantil", titulos: ["cuidador de niños", "nana", "parvularia", "técnico en atención de párvulos", "asistente de párvulos", "asistente furgón escolar", "asistente de furgón escolar", "monitora de transporte escolar"] },
  ...
  { codigo: "7231", grupo: "Mecánicos automotrices", titulos: ["mecánico automotriz", "mecánico de vehículos", "mecánico de autos", "mecánico de automóviles", "técnico mecánico automotriz", "mecánico de taller", "desabollador", "pintor automotriz", "hojalatero"] },
  ...
  { codigo: "7411", grupo: "Electricistas de edificios y obras", titulos: ["electricista", "electricista de construcción", "electricista de obra", "instalador eléctrico", "electricista de mantención", "electricista de edificios", "electricista industrial", "maestro mayor eléctrico", "maestro electricista"] },
  ...
  { codigo: "9613", grupo: "Personal de aseo y limpieza", titulos: ["auxiliar de aseo", "personal de aseo", "operario de aseo", "aseador", "camarera de hotel", "mucama", "lavador de vehículos", "encargado de maestranza", "auxiliar de maestranza"] },
];
