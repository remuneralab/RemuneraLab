    ...
    <div ref={ref} className="flex flex-col items-center gap-2">
      <svg width="144" height="84" viewBox="0 0 144 84" className="overflow-visible">
        <path
          ...
          fill="none" stroke="#efedf0" strokeWidth={12} strokeLinecap="round"
        />
        <motion.path
          d={`M 14 72 A ${r} ${r} 0 0 1 130 72`}
          fill="none"
        ...
        />
        <text x="72" y="64" textAnchor="middle" fontSize={28} fontWeight={700} fill="#00152a">{score}</text>
        <text x="72" y="78" textAnchor="middle" fontSize={10} fontWeight={600} fill="#43474d">/ 100</text>
      </svg>
