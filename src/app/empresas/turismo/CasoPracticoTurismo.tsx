...
const ROLES = [
  {
    rol: "Camareras de piso",
    n: 45, rotaciones: 23,
    costoUnitario: 1_320_000,
    costoTotal:   30_360_000,
    color: "#ef4444",
  },
  {
    rol: "Garzones / Bartenders",
    n: 38, rotaciones: 20,
    costoUnitario: 1_850_000,
    costoTotal:   37_000_000,
    color: "#f97316",
  },
  {
    rol: "Recepcionistas",
    n: 26, rotaciones: 13,
    costoUnitario: 2_100_000,
    costoTotal:   27_300_000,
    color: "#f59e0b",
  },
  {
    rol: "Personal de cocina",
    n: 32, rotaciones: 16,
    costoUnitario: 1_650_000,
    costoTotal:   26_400_000,
    color: "#eab308",
  },
];
    ...
    <section className="py-20 bg-surface">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-3 gap-5 mb-12">
          {[
            { icon: CircleDollarSign, label: "Costo anual rotación",        valor: fmtCLP(COSTO_ACTUAL),   sub: "72 rotaciones · 4 categorías",   color: "text-red-500",     bg: "bg-red-50 border-red-100"                              },
            { icon: TrendingDown,     label: "Con plan de retención (22%)", valor: fmtCLP(COSTO_OBJETIVO), sub: "estimación año 1",                color: "text-emerald-600", bg: "bg-emerald-50 border-emerald-100"                      },
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-14">
          <div className="bg-white rounded-lg p-6 border border-outline-variant/30">
            <p className="text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-1">Desglose por área</p>
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={barData} layout="vertical" margin={{ top: 0, right: 12, left: 0, bottom: 0 }} barSize={18}>
                  ...
                  <YAxis type="category" dataKey="rol" axisLine={false} tickLine={false} tick={{ fontSize: 11, fill: "#43474d" }} width={150} />
        ...
        <div className="mb-12">
          <h3 className="text-xl font-bold text-primary mb-6">Impacto específico del sector turismo</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-xl bg-secondary flex items-center justify-center text-on-primary font-bold text-sm shrink-0">VR</div>
                <div>
                  <p className="font-bold text-primary text-sm">Valentina Rojas</p>
                  <p className="text-xs text-on-surface-variant">Analista Customer Experience · 8 años en hotelería</p>
                </div>
              ...
              <div className="text-xs text-on-surface leading-relaxed space-y-3">
                <p>
                  ...
                  el 31% de la dotación pero el <strong className="text-primary">31% del costo de rotación</strong>
                ...
                <p>
                  ...
                  <strong className="text-primary"> paradoja de servicio</strong>: el hotel está más lleno y
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              className="bg-white rounded-lg border border-outline-variant/30 p-6 flex flex-col gap-5">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-xl bg-primary flex items-center justify-center text-on-primary font-bold text-sm shrink-0">RP</div>
                <div>
                  <p className="font-bold text-primary text-sm">Rodrigo Pizarro</p>
                  <p className="text-xs text-on-surface-variant">Especialista RRHH · ex-Marriott Chile · 11 años en cadenas</p>
                </div>
              ...
              <div className="text-xs text-on-surface leading-relaxed space-y-3">
                <p>
                  ...
                  <strong className="text-primary"> las camareras de piso no se van por el sueldo</strong>.
                ...
                <p>
                  El otro factor invisible es la <strong className="text-primary">Ley 20.803 de propinas</strong>.
