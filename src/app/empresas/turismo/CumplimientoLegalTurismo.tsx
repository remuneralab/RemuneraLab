...
const CHECKLIST = [
  ...
  },
  {
    ...
    detalle: "La Ley 20.803 (vigente desde 2016) exige que toda propina voluntaria sea recaudada por el establecimiento y distribuida en proporciones definidas. El manejo informal —propinas en efectivo que el trabajador retiene sin pasar por liquidación— genera deuda tributaria y previsional acumulada y puede ser calificado como apropiación indebida de remuneraciones.",
    pts: 0,
  },
  {
    ...
    <section className="py-20 bg-surface">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-sm text-on-surface-variant max-w-2xl mb-10">
          ...
          la <strong className="text-primary">Ley 20.803 de propinas</strong>, vigente desde 2016 y
          masivamente incumplida. Junto a la <strong className="text-primary">Ley Karin</strong> y el
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-lg border border-red-200 bg-red-50/60 p-5">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <p className="text-sm font-bold text-primary">Ley 20.803 (Propinas) — vigente desde 2016</p>
              ...
              <p className="text-[10px] text-on-surface-variant mt-2">* Deuda retroactiva con 30 garzones, 2 años de incumplimiento puede superar $180.000.000 CLP.</p>
            </div>
        ...
        {/* Info Recargo nocturno + Ley 20.348 */}
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="flex items-start gap-3 bg-amber-50 border border-amber-100 rounded-xl p-4">
            <Info size={14} className="text-amber-500 shrink-0 mt-0.5" />
            <p className="text-[11px] text-on-surface-variant leading-relaxed">
              <strong className="text-primary">Recargo nocturno (Art. 38 CT):</strong> todo trabajo
          ...
          <div className="flex items-start gap-3 bg-secondary-container/20 border border-secondary-container/40 rounded-xl p-4">
            ...
            <p className="text-[11px] text-on-surface-variant leading-relaxed">
              <strong className="text-primary">Ley Transparencia Salarial (2025–26):</strong> cadenas
