...
function gapStyle(nivel: GapLevel) {
  if (nivel === "CRÍTICO")  return { badge: "bg-red-100 text-red-700",    dot: "bg-red-500"    };
  if (nivel === "ALTO")     return { badge: "bg-orange-100 text-orange-700", dot: "bg-orange-500" };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className={`fixed top-0 w-full z-40 transition-all duration-300 ${
        scrolled ? "bg-white/95 backdrop-blur-md border-b border-outline-variant/20" : "bg-transparent"
      }`}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <a href="/" className="font-bold text-primary text-lg tracking-tight">RemuneraLab</a>
      ...
      <div className="pt-14">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <motion.div
                ...
                className="sm:col-span-1 border border-outline-variant/20 rounded-lg p-5"
              >
              ...
              >
                {[
                  ...
                  <div key={i} className="p-4 text-center">
                    <div className="text-xl sm:text-2xl font-bold text-indigo-600">{k.valor}</div>
        ...
        <div className="border-b border-outline-variant/20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
            <motion.div
              ...
              className="mb-6"
            >
              <h2 className="text-xl font-bold text-on-surface mb-1">Tu mapa salarial vs mercado</h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="hidden sm:grid grid-cols-[2fr_1fr_1fr_80px_90px] gap-x-4 items-center">
                      ...
                      <span className="font-mono text-sm text-on-surface">{fmtM(r.actual)}</span>
                      <span className="font-mono text-sm text-emerald-700">{fmtM(r.mercado)}</span>
                    ...
                    <div className="sm:hidden">
                      ...
                      <div className="flex gap-4 text-xs">
                        <span className="text-on-surface-variant">Actual: <span className="font-mono font-semibold text-on-surface">{fmtM(r.actual)}</span></span>
                        <span className="text-on-surface-variant">Mercado: <span className="font-mono font-semibold text-emerald-700">{fmtM(r.mercado)}</span></span>
        ...
        <div className="border-b border-outline-variant/20 bg-surface-container/20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-xl font-bold text-on-surface mb-1">La alerta que nunca llegó</h2>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, ease: E }}
              viewport={{ once: true }}
              className="max-w-xl border border-outline-variant/30 rounded-xl overflow-hidden shadow-sm"
            >
              {/* Notification header */}
              ...
              <div className="bg-white p-5">
                ...
                {/* Cargo + empresa */}
                <div className="mb-5">
                  <p className="text-base font-bold text-on-surface">Desarrollador Full Stack Senior</p>
                  <p className="text-sm text-on-surface-variant">{EMPRESA.nombre} · Santiago</p>
                </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <div className="flex justify-between text-xs text-on-surface-variant mb-1">
                        ...
                        <span className="font-semibold text-emerald-600">Percentil 55</span>
                      </div>
                      <div className="h-2 bg-surface-container rounded-full overflow-hidden">
                    ...
                    <div>
                      <div className="flex justify-between text-xs text-on-surface-variant mb-1">
                        ...
                        <span className="font-semibold text-red-600">Percentil 29</span>
                      </div>
                      <div className="h-2 bg-surface-container rounded-full overflow-hidden">
                ...
                <p className="text-sm text-on-surface-variant mb-4 leading-relaxed">
                  ...
                  <strong className="text-on-surface"> $4.200.000 y $5.800.000</strong>. Tu equipo senior está expuesto.
                </p>
        ...
        <div className="border-b border-outline-variant/20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-xl font-bold text-on-surface mb-1">Lo que ocurrió sin RemuneraLab</h2>
              <p className="text-sm text-on-surface-variant">12 meses de pérdidas que empezaron con una señal que nadie vio.</p>
            </motion.div>
        ...
        <div className="border-b border-outline-variant/20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-xl font-bold text-on-surface mb-1">El costo de saber vs no saber</h2>
              <p className="text-sm text-on-surface-variant">La diferencia entre actuar en enero y reaccionar en diciembre.</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="border border-indigo-200 rounded-lg p-5 flex flex-col"
              >
                <div className="flex items-center gap-2 mb-5">
                ...
                <div className="space-y-3 mb-5">
                  {CON_RL.map((item) => (
                    <div key={item.label} className="flex justify-between items-start gap-3">
                      <span className="text-xs text-on-surface-variant leading-relaxed">{item.label}</span>
                      <span className="text-xs font-mono font-semibold text-indigo-700 whitespace-nowrap">{item.monto}</span>
                    </div>
                  ))}
                </div>
                <div className="mt-auto space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-2">
                      ...
                      <span className="text-xs text-indigo-800">{txt}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, ease: E }}
              viewport={{ once: true }}
              className="bg-indigo-50 border border-indigo-300 rounded-xl p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4"
            >
              <div>
              ...
              <div className="text-6xl font-bold text-indigo-600 shrink-0">
        ...
        {/* ── Fuentes ──────────────────────────────────────────────────── */}
        <div className="border-b border-outline-variant/20 bg-surface-container/10">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="mb-6"
            >
              <h2 className="text-lg font-bold text-on-surface mb-1">Metodología y fuentes</h2>
              <p className="text-sm text-on-surface-variant">
            ...
            <div className="space-y-3">
              {FUENTES.map((f, i) => (
                ...
                >
                  ...
                  <p className="text-xs font-mono text-on-surface-variant/60 mt-1.5 truncate">{f.url}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-primary py-20 sm:py-28">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-10">
            <div className="max-w-xl">
              <p className="text-xs font-semibold uppercase tracking-widest text-white/50 mb-4">Para tu empresa</p>
